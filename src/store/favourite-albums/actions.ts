import {ADD_ALBUM_TO_FAVOURITE, DELETE_ALBUM_FROM_FAVOURITE, SET_SINGLE_ARTIST_NAME, RESET_SINGLE_ARTIST_NAME} from './ constants';
...
export const resetSingleArtistName = () => {
    return {type: RESET_SINGLE_ARTIST_NAME,}
} 